...
export const MainLayout = () => {
  ...
  const pageMeta = location.pathname.startsWith('/usuarios')
    ? {
        eyebrow: 'Usuarios',
        title: 'Gestión de usuarios',
        description:
          'Crea usuarios, consulta el listado y asigna roles de paciente, especialista o administrador.',
      }
    : location.pathname.startsWith('/casos/')
      ? {
          ...
          description:
            'Consulta la imagen inicial, la predicción automática, el diagnóstico clínico y la validación final.',
        }
      : {
          eyebrow: 'Casos',
          title: 'Listado de casos',
          description:
            'Consulta los casos disponibles, su estado, su responsable y el flujo clínico asociado.',
        };
        ...
        <aside className='flex w-full flex-col border-b border-slate-200/80 bg-slate-950 px-5 py-6 text-white lg:min-h-screen lg:w-80 lg:border-b-0 lg:border-r lg:border-slate-800'>
          ...
          <div className='mt-6 space-y-2'>
            ...
            <p className='text-sm leading-6 text-slate-300'>
              Vista principal del flujo clínico: imagen, predicción, diagnóstico
              y validación.
            </p>
          </div>
          ...
          <nav className='mt-8 space-y-3'>
            ...
            >
              ...
              <div>
                <p className='font-medium'>Casos clínicos</p>
                <p className='text-xs text-slate-400'>
                  Imagen, predicción, diagnóstico y validación
                </p>
              </div>
            </NavLink>
          ...
          >
            ...
            {isAuthenticated ? 'Cerrar sesión' : 'Ir a acceso'}
          </button>
        </aside>
        ...
        <div className='flex min-h-screen min-w-0 flex-1 flex-col'>
          ...
          <main className='flex-1 px-4 py-6 sm:px-6 lg:px-10 lg:py-8'>
            <div
              ...
              className='mx-auto max-w-6xl page-fade-in'
            >
              <Outlet />
            </div>
          </main>
